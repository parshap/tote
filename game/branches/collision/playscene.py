...
class PlayScene(ogre.FrameListener, ogre.WindowEventListener):
    ...
    def setupScene(self):
        ...
        boundary1.bounding_shape = gamestate.collision.BoundingLineSegment(ogre.Vector3(-90, 0, -90),
                                                                           ogre.Vector3(90, 0, -90),
                                                                           ogre.Vector3(0, 0, 1))
        # south wall
        boundary2 = gamestate.objects.GameObject(self.world)
        boundary2.position = (-90, 90)
        boundary2.isPassable = False
        boundary2.bounding_shape = gamestate.collision.BoundingLineSegment(ogre.Vector3(-90, 0, 90),
                                                                           ogre.Vector3(90, 0, 90),
                                                                           ogre.Vector3(0, 0, -1))
        # east wall
        ...
        boundary3.bounding_shape = gamestate.collision.BoundingLineSegment(ogre.Vector3(90, 0, -90),
                                                                           ogre.Vector3(90, 0, 90),
                                                                           ogre.Vector3(-1, 0, 0))
        # west wall
        ...
        boundary4.bounding_shape = gamestate.collision.BoundingLineSegment(ogre.Vector3(-90, 0, -90),
                                                                           ogre.Vector3(-90, 0, 90),
                                                                           ogre.Vector3(1, 0, 0))
